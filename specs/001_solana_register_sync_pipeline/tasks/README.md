...
- [ ] 01 — [Feature-flagged `declare_id!` for a prod register instance](./01_register_prod_feature_flag.md)
...
- [ ] 04 — [DynamoDB registrations table and 14-day queue retention](./04_terraform_dynamodb_and_queue_retention.md)
