...
- Install [`golangci-lint`](https://golangci-lint.run/welcome/install/#local-installation) for linting. See
  [`.golangci-lint-version`](./.golangci-lint-version) for supported version.
